...
pub struct TranslationConfig {
    ...
    /// Translate every readable line in the capture region, not only text that
    /// behaves like a subtitle track. See `translation_eligibility` for what
    /// this bypasses and what it leaves in place.
    pub translate_all_ocr_text: bool,
...
impl TranslationConfig {
    /// Which OCR text this configuration lets the pipeline translate.
    pub fn eligibility(&self) -> Eligibility {
        Eligibility::from_translate_all(self.translate_all_ocr_text)
    }
