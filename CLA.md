...
intentionally submitted to Meowcal Sub (the "Project"). The Maintainer is the
copyright holder of Meowcal Sub, currently the GitHub user
...
or counterclaim, alleging that the Project or a Contribution incorporated in it
constitutes direct or contributory patent infringement, any patent licenses
granted to you under this Agreement for that Project terminate when the
litigation is filed.
...
of Meowcal Sub offered to organizations that require terms outside AGPL-3.0.
