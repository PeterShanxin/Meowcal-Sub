...
it. It explains _why_ the repository is shaped the way it is. It is not a
...
Examples include the curated HY-MT product stack (ADR-0001), the
engine-manifest trust boundary (ADR-0002), the incremental Lit frontend
(ADR-0003), and the shared Core boundary (ADR-0004).
...
_absence_ of the reasoning. If yes, write the ADR; if no, the decision belongs
