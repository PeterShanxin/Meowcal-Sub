...
Measured on 2026-08-02 after the OCR rejection-reason extraction milestone:

- 98 production files under `src/` and `src-tauri/src/`;
...
| ------------------------------------ | ------: | -------------------- |
| `src-tauri/src/commands.rs`          |   2,274 | #31                  |
