...
**Windows 11 公开测试版 · v0.8.1** — [更新说明与全部安装文件](https://github.com/PeterShanxin/Meowcal-Sub/releases/tag/v0.8.1)。

| 你的电脑 | 安装包 |
| --- | --- |
| Intel / AMD Windows 电脑 | **[下载 x64（.exe）](https://github.com/PeterShanxin/Meowcal-Sub/releases/download/v0.8.1/Meowcal.Sub_0.8.1_x64-setup.exe)** |
| 骁龙或其他 Windows on ARM 电脑 | **[下载 ARM64（.exe）](https://github.com/PeterShanxin/Meowcal-Sub/releases/download/v0.8.1/Meowcal.Sub_0.8.1_arm64-setup.exe)** |
